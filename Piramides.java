...
public class Piramides {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Eliga alguna de las opciones");
        ...
        switch (opcion) {
            ...
            case 2:
                ...
                for (int i = 1; i <= filas; i++) {
                    // Imprimir los caracteres según el patrón
                    for (int j = 1; j <= i; j++) {
                        if (i % 2 == 1) {
                            // Imprimir números si el nivel es impar
                            System.out.print(valor + " ");
                            valor++;
                        } else {
                            // Imprimir letras si el nivel es par
